<<<<<<< HEAD
# whim-vim-api
API Project for GA SEI TESTING #2
=======
...
1. Rename the directory from whim-vim-api -> your-app-name.
1. Empty [`README.md`](README.md) and fill with your own content.
1. Move into the new project and `git init`.
1. Replace all instances of `'whim-vim-api'` with your app name.
